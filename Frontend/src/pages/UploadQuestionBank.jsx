...
function UploadQuestionBank() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (
      ...
      alert(
        "Accept at least one AI-generated question before submitting"
      );
    ...
    for (let q of questionsToSubmit) {
      ...
      if (
        ...
        alert(
          "Please fill all fields for every question"
        );
  ...
  return (
    <ERPLayout>
      ...
      <h2 className="erp-title text-center">
                ...
                import("xlsx")
                  .then((XLSX) => {
                    ...
                    reader.onload = (
                      ...
                      alert(
                        `Loaded ${parsedQuestions.length} questions from Excel.`
                      );
                    };
